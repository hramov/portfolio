<template>
  <div
    class="d-flex flex-column flex-shrink-0 p-3 bg-light sticky-top"
  ...
  >
    ...
    <div class="dropdown">
      ...
      >
        <img
          src="https://avatars.githubusercontent.com/u/56201987?s=40&v=4"
          alt=""
          width="32"
          height="32"
          class="rounded-circle me-2"
        />
        <strong>Храмов Сергей</strong>
      </a>
    </div>
    <hr />
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li class="nav-item">
        <a href="#skills" class="nav-link link-dark" aria-current="page">
          <svg class="bi me-2" width="16" height="16">
      ...
      <li class="nav-item">
        <a href="#experience" class="nav-link link-dark" aria-current="page">
          <svg class="bi me-2" width="16" height="16">
            <use xlink:href="#grid" />
          </svg>
          Опыт работы
